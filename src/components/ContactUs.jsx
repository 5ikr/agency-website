...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "3dfd4985-8881-4d21-9246-e6864adbb813");
    ...
    return (
        <motion.div initial='hidden' whileInView='visible' transition={{staggerChildren: 0.2}} viewport={{once:true}} id="contact-us" className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <Title title='Contact Us' description='Reach out to us, from strategy to execution, we craft digital solutions' />
        
            <motion.form initial={{opacity:0, y: 20}} whileInView={{opacity:1, y:0}} transition={{duration:0.5, delay: 0.4}} viewport={{once:true}} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full' onSubmit={onSubmit}>
